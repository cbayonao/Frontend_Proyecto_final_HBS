        ...
        <LoginStyle>
            <div className="Login-container">
                ...
                <FormStyle onSubmit={onSubmit}>
                    ...
                    <DivInputStyle>
                        <InputStyle value={email} onChange={event => setEmail(event.target.value)} type="email" name="email" id="InputEmail" placeholder="Ingresa tu Email" />
                    </DivInputStyle>
                    <DivInputStyle>
                        <InputStyle value={password} onChange={event => setPassword(event.target.value)} type="password" name="password" id="InputPassword" placeholder="Ingresa tu Contraseña" />
                    </DivInputStyle>
                    <DivCheckbox>
